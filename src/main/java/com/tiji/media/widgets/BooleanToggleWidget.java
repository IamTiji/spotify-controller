...
public class BooleanToggleWidget extends ClickableWidget implements ValueHolder {
    ...
    private static final Text OFF_TEXT = Text.translatable("ui.media.toggle.off").formatted(Formatting.RED);
    private static final Text ON_TEXT = Text.translatable("ui.media.toggle.on").formatted(Formatting.GREEN);
