...
public class SetupScreen extends LightweightGuiDescription {
    public SetupScreen() {
        ...
        welcomeLabel.setColor(0xFF000000).setDarkmodeColor(0xFFFFFFFF);
        ...
        setupLabel1.setColor(0xFF000000).setDarkmodeColor(0xFFFFFFFF);
        ...
        setupLabel2.setColor(0xFF000000).setDarkmodeColor(0xFFFFFFFF);
