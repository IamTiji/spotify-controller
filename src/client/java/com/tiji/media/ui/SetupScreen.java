...
public class SetupScreen extends LightweightGuiDescription {
    public SetupScreen() {
        ...
        WButton linkLabel = new WButton(Text.literal("localhost:25566").formatted(Formatting.UNDERLINE));
        linkLabel.setOnClick(() -> Util.getOperatingSystem().open("http://localhost:25566"));
